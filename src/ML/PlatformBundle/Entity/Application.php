 ...
 * @ORM\Entity(repositoryClass="ML\PlatformBundle\Repository\ApplicationRepository")
 */
class Application
{
    /**
    * @ORM\ManyToOne(targetEntity="ML\PlatformBundle\Entity\Advert", inversedBy="applications")
